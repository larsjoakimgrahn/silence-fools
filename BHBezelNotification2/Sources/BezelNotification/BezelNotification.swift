...
public struct NotificationBezel {
    ...
    public static func show(with parameters: BezelParameters,
        ...
        let bezelWindow = BezelWindow(parameters: parameters)
        bezelWindows.insert(bezelWindow)
        
        
        
        class BezelDelegateImpl: BezelDelegate {

            var shouldFadeOut = true
            weak var bezelWindow: BezelWindow?
            let afterHideCallback: AfterHideCallback
            
            
            init(bezelWindow: BezelWindow,
                 afterHideCallback: @escaping AfterHideCallback) {
        ...
        let delegate = BezelDelegateImpl(bezelWindow: bezelWindow, afterHideCallback: afterHideCallback)
...
public class BezelWindow : NSWindow {
    
    private lazy var bezelContentView: BezelContentView = {
        let bezelContentView = BezelContentView(parameters: self.parameters)
...
public class BezelContentView: NSView {
